...
To verify these models using the theorem proving approach described in Section~\ref{Verification},
the new type, new predicates, and the non-classical connectives in the problem, have to be
expressed in TXF/THF.

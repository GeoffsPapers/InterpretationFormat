...
% quantification}).
Formulae can be evaluated wrt Kripke interpretations with finite worlds and local terms:
\begin{packed_itemize}
...
The TPTP format represents interpretations in \emph{interpretation-formulae} -- the details 
...
For this work the Success ontology was extended with a new value \emph{ModelExtending} (MEX).
...
The satisfiable formulae can be proved from the sets that result from applying the transformations.
...
A simple Tarskian interpretation-formula is a conjunction of components (see simple examples 
in~\cite[\S\ref{FOF_Finite.s}, \S\ref{TFF_Finite.s}, \S\ref{TFF_Finite_SeparateDomains.s}, 
\S\ref{THF_Finite.s}]{SS+26-Appendix}):
\begin{packed_itemize}
...
\end{packed_itemize}
The TPTP format for Tarskian interpretation-formulae requires only one change to the TPTP
language syntax -- the addition of the \smalltt{interpretation} role that is used for
...
Examples of Tarskian interpretations as single interpretation-formulae are 
in~\cite[\S\ref{FOF_Finite.s}, \S\ref{TFF_Finite.s}, \S\ref{TFF_Peano.s}, \S\ref{TFF_Integer.s}, 
\S\ref{THF_Finite.s}]{SS+26-Appendix}, illustrating the components described below. 
Tarskian interpretations split over multiple interpretation-formulae, as 
in~\cite[\S\ref{FOF_Finite_Medium.s}, \S\ref{FOF_Finite_Fine.s}, \S\ref{TFF_Finite_Medium.s},
\S\ref{TFF_Finite_Fine.s}, \S\ref{THF_Finite_Medium.s}]{SS+26-Appendix}, are explained in 
Section~\ref{NewTarskianSplit}.
Tarskian interpretations that are compacted using quantification, as 
in~\cite[\S\ref{TFF_Finite_Compact.s}]{SS+26-Appendix}, are explained in 
Section~\ref{NewTarskianCompact}.
Examples of interpretation-formulae that determine Herbrand interpretations, as 
in \cite[\S\ref{FOF_Formulae.s}, \S\ref{FOF_Saturation.s}]{SS+26-Appendix}, are explained in 
...
%--------------------------------------------------------------------------------------------------
\subsection{Finite Interpretations with No Types}
\label{FOFTarskian}

\cite[\S\ref{FOF_Finite.p}]{SS+26-Appendix} shows a FOF problem that has a countermodel with a 
finite domain, shown in~\cite[\S\ref{FOF_Finite.s}]{SS+26-Appendix}.

The domain specification is a conjunction of:
\begin{packed_itemize}
...
\cite[\S\ref{FOF_Finite.s.p}]{SS+26-Appendix} shows the verification problem for the model.

%--------------------------------------------------------------------------------------------------
\subsection{Finite Interpretations reusing Problem Types}
\label{TarskianReusingTypes}

\cite[\S\ref{TFF_Finite.p}]{SS+26-Appendix} shows a TFF problem that has a countermodel with
finite domains, which is shown in~\cite[\S\ref{TFF_Finite.s}]{SS+26-Appendix}.
...
\cite[\S\ref{TFF_Finite.s.p}]{SS+26-Appendix} shows the verification problem for the model.
...
\cite[\S\ref{TFF_Finite.p}]{SS+26-Appendix} shows a TFF problem that has a countermodel with
finite domains, which is shown in~\cite[\S\ref{TFF_Finite_SeparateDomains.s}]{SS+26-Appendix}.
\cite[\S\ref{THF_Finite.p}]{SS+26-Appendix} shows a THF problem that has a countermodel with
finite domains, which is shown in~\cite[\S\ref{THF_Finite.s}]{SS+26-Appendix}.
...
\cite[\S\ref{TFF_Finite_SeparateDomains.s.p}, \S\ref{THF_Finite.s.p}]{SS+26-Appendix}
show the verification problems for the models.
...
\smalltt{\$int}.
\cite[\S\ref{TFF_Infinite.p}]{SS+26-Appendix} shows a TFF problem that has a model with an 
infinite domain.
\cite[\S\ref{TFF_Peano.s}]{SS+26-Appendix} shows the model with an infinite term domain, and
\cite[\S\ref{TFF_Integer.s}]{SS+26-Appendix} shows the model with a \smalltt{\$int} domain.
...
\cite[\S\ref{TFF_Peano.s.p}, \S\ref{TFF_Integer.s.p}]{SS+26-Appendix} show the verification
...
interpretation.
\cite[\S\ref{FOF_Finite_Medium.s}, \S\ref{TFF_Finite_Medium.s}]{SS+26-Appendix}
show examples of splitting the interpretation-formulae 
in the FOF and TFF 
interpretations~\cite[\S\ref{FOF_Finite.s}, \S\ref{TFF_Finite.s}]{SS+26-Appendix} respectively, 
which separate the domain specifications from the symbol mappings, 
e.g.,~in~\cite[\S\ref{TFF_Finite_Medium.s}]{SS+26-Appendix}:\\
\hspace*{0.5cm}\smalltt{tff(garfield\_domains,interpretation-domains} \\
contains the information about the two domains, and the interpretation-formula: \\
\hspace*{0.5cm}\smalltt{tff(garfield\_mappings,interpretation-mappings} \\
...
\cite[\S\ref{FOF_Finite_Fine.s}, \S\ref{TFF_Finite_Fine.s}]{SS+26-Appendix} show examples of
splitting the interpretation-formulae 
in~\cite[\S\ref{FOF_Finite.s}, \S\ref{TFF_Finite.s}]{SS+26-Appendix} respectively,
e.g.,~in~\cite[\S\ref{TFF_Finite_Fine.s}]{SS+26-Appendix}:\\
...
\cite[\S\ref{THF_Finite_Medium.s}]{SS+26-Appendix} shows an example of mixed splitting 
of~\cite[\S\ref{THF_Finite.s}]{SS+26-Appendix}, where the domains are specified separately in the 
interpretation-formulae: \\
\hspace*{0.5cm}\smalltt{thf(hot\_coffee\_beverage,interpretation-domains(beverage,d\_beverage)} \\
and: \\
\hspace*{0.5cm}\smalltt{thf(hot\_coffee\_syrup,interpretation-domains(syrup,d\_syrup)} \\
while all the symbol mappings are in: \\
\hspace*{0.5cm}\smalltt{thf(hot\_coffee,interpretation-mappings}
...
\cite[\S\ref{TFF_Finite_Compact.s}]{SS+26-Appendix} shows an example compacting the
interpretation-formula \smalltt{garfield\_mapping\_loves} 
~in~\cite[\S\ref{TFF_Finite.s}]{SS+26-Appendix}.
...
The problem in~\cite[\S\ref{FOF_Finite.p}]{SS+26-Appendix} has a HI-formulae model formed from 
predicate definitions over the term algebra, which is shown 
in~\cite[\S\ref{FOF_Formulae.s}]{SS+26-Appendix}.
The problem in~\cite[\S\ref{FOF_Finite.p}]{SS+26-Appendix} also has a saturation, which is shown 
in~\cite[\S\ref{FOF_Saturation.s}]{SS+26-Appendix}.
\cite[\S\ref{FOF_Formulae.s.p}, \S\ref{FOF_Saturation.s.p}]{SS+26-Appendix} show the corresponding
...
in~\cite[\S\ref{TFF_Finite_SeparateDomains.s}]{SS+26-Appendix}.
...
% of TXF.
The TPTP format for Kripke interpretation-formulae requires the \smalltt{interpretation} role that
is used for interpretation-formulae, and adds four defined symbols:
\begin{packed_itemize}
...
Examples of Kripke interpretations as single interpretation-formulae are 
in~\cite[\S\ref{NXF_Finite-Finite-Global.s}, \S\ref{NXF_Finite-Finite-Local.s}]{SS+26-Appendix}, 
illustrating the components described below. 
Kripke interpretations split over multiple interpretation-formulae, as 
in~\cite[\S\ref{NXF_Finite-Finite-Global_Medium.s}, \S\ref{NXF_Finite-Finite-Global_Fine.s}]{SS+26-Appendix}, \
are explained in Section~\ref{NewKripkeSplitCompact}.
Tarskian interpretations that are compacted using quantification, as 
in~\cite[\S\ref{NXF_Finite-Finite-Global_Compact.s}]{SS+26-Appendix}, are explained in 
...
\cite[\S\ref{NXF_Finite-Finite-Global.p}]{SS+26-Appendix} shows a NXF problem that has a 
countermodel with finite worlds, each of which contains a finite Tarskian interpretation, which 
is shown in~\cite[\S\ref{NXF_Finite-Finite-Global.s}]{SS+26-Appendix}.
...
\cite[\S\ref{NXF_Finite-Finite-Local.p}]{SS+26-Appendix} shows a NXF problem that has both local
and global axioms.
It has a countermodel with finite worlds each of which contains a finite Tarskian interpretation, 
which is shown in~\cite[\S\ref{NXF_Finite-Finite-Local.s}]{SS+26-Appendix}
This example illustrates how a local axiom (with role \smalltt{axiom-local}) is satisfied in 
only the local world (\smalltt{w1}).
\cite[\S\ref{NXF_Finite-Finite-Local.s.p}]{SS+26-Appendix} shows the verification problem for the
model.
...
\smalltt{domains}, and \smalltt{mappings}.
\cite[\S\ref{NXF_Finite-Finite-Global_Medium.s}]{SS+26-Appendix} shows a medium grained split of 
\cite[\S\ref{NXF_Finite-Finite-Global.s}]{SS+26-Appendix}.
...
e.g.,~in~\cite[\S\ref{NXF_Finite-Finite-Global_Medium.s}]{SS+26-Appendix} the
...
\cite[\S\ref{NXF_Finite-Finite-Global_Fine.s}]{SS+26-Appendix} shows a more fine grained split of 
\cite[\S\ref{NXF_Finite-Finite-Global.s}]{SS+26-Appendix}, in which the interpretation-formula: \\
\hspace*{0.5cm}\smalltt{tff(child\_domains,interpretation-domains(child,child\_d)} \\
contains the information about the domain \smalltt{child\_d}, the interpretation-formula: \\
\hspace*{0.5cm}\smalltt{tff(people\_mappings,interpretation-mappings(charly,child\_d)} \\
...
\cite[\S\ref{NXF_Finite-Finite-Global_Compact.s}]{SS+26-Appendix} shows a compacted version of
\cite[\S\ref{NXF_Finite-Finite-Global.s}]{SS+26-Appendix}, in which the interpretation-formula: \\
\hspace*{0.5cm}\smalltt{tff(people\_domains,interpretation-domains} \\
\hspace*{0.9cm}\smalltt{! [W: \$world] :} \\
\hspace*{1.3cm}\smalltt{\$in\_world(W,}\emph{the domain specification} \\
...
\cite[\S\ref{NXF_Finite-Finite-Global.p}, \S\ref{NXF_Finite-Finite-Local.p}]{SS+26-Appendix})
because the logical setting is captured in the interpretation-formulae.
...
\cite[\S\ref{NXF_Finite-Finite-Global.s.p}]{SS+26-Appendix} shows the NXF verification problem for
the problem in~\cite[\S\ref{NXF_Finite-Finite-Global.p}]{SS+26-Appendix} and its countermodel 
in~\cite[\S\ref{NXF_Finite-Finite-Global.s}]{SS+26-Appendix}.
\cite[\S\ref{NXF_Finite-Finite-Local.s.p}]{SS+26-Appendix} shows the NXF verification problem for
the problem
in~\cite[\S\ref{NXF_Finite-Finite-Local.p}]{SS+26-Appendix} and its countermodel 
in~\cite[\S\ref{NXF_Finite-Finite-Local.s}]{SS+26-Appendix}.
...
e.g.,~in~\cite[\S\ref{NXF_Finite-Finite-Global.p}]{SS+26-Appendix} the axiom: \\
\hspace*{0.5cm}\smalltt{tff(a1,axiom} \\
\hspace*{0.8cm}\smalltt{! [C: child] : \tildenot{}\,( \tildenot{}\,quiet(C) \& ? [A: adult] : sleepy(A) ) ).}\\
is global (the default), so the NXF verification conjecture 
in~\cite[\S\ref{NXF_Finite-Finite-Global.s.p}]{SS+26-Appendix} has the \smalltt{global} subrole: \\
...
\hspace*{0.5cm}\smalltt{tff(c,conjecture-local}
...
\caption{IIV view of the Kripke model in~\cite[\S\ref{TFF_Finite_SeparateDomains.s}]{SS+26-Appendix}}
\label{IKVPicture}
\end{figure}
...
The TPTP format provides very many options and features, and it is expected that only the 

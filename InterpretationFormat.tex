...
The new TPTP format represents interpretations in {\em interpretation-formulae} -- the details 
...
\item Interpretation of boolean symbols, as literals formed from symbols applied to domain 
      elements; positive literals are {\em true} and negative literals are {\em false}.
\end{packed_itemize}
...
with a complete accessibility relation (meeting the requirements of model logic {\bf M})~\ldots \\

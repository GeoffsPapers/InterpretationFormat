...
\newpage
\subsection{A FOF Interpretation with a Finite Domain, Fine Grained}
\begin{small}
\verbatiminput{FOF_Finite_Medium.s}
\end{small}

\newpage
\subsection{A FOF Interpretation with a Finite Domain, Compacted}
\begin{small}
\verbatiminput{FOF_Finite_Compact.s}
\end{small}
...
\newpage
\subsection{A TF0 Interpretation with an Infinite Domain}
\begin{small}

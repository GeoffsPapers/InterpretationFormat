...
\item A formula making the type-promotion function an injection, which together with the 
      ...
      \hspace*{0.75cm}\smalltt{ ( ( ( d2beverage @ DB1 ) = ( d2beverage @ DB2 ) ) => ( DB1 = DB2 ) )}
\end{packed_itemize}
...
problems for the models. UPDATE
...
and in Appendix~\ref{THF_Finite_Compact.s} universal quantification is used for all functions of
type {\tt beverage > syrup} and all {\tt syrups}, applying the function to {\tt d\_coffee} and
the syrup results in {\tt d\_coffee}~\ldots \\

...
They are introduced with a \example{}:\cite{SS+26-Appendix} tag.
...
\example{}:\cite[\S\ref{FOF_Finite.s}, \S\ref{TFF_Finite.s}, 
...
\example{}:\cite[\S\ref{FOF_Finite.s}, \S\ref{TFF_Finite.s}, \S\ref{TFF_Peano.s}, 
...
\example{}:\cite[\S\ref{FOF_Finite_Medium.s}, \S\ref{FOF_Finite_Fine.s}, 
...
\example{}:\cite[\S\ref{TFF_Finite_Compact.s}]{SS+26-Appendix} illustrates a Tarskian 
interpretation that is compacted using quantification, as explained in 
Section~\ref{NewTarskianCompact}.
\example{}:\cite[\S\ref{FOF_Formulae.s}, \S\ref{FOF_Saturation.s}]{SS+26-Appendix}
...
\example{}:\cite[\S\ref{FOF_Finite.p}]{SS+26-Appendix} shows a FOF problem that has a 
countermodel with a finite domain, which is shown in 
\example{}:\cite[\S\ref{FOF_Finite.s}]{SS+26-Appendix}.
...
\example{}:\cite[\S\ref{FOF_Finite.s.p}]{SS+26-Appendix} shows the verification problem for 
the model.
...
\example{}:\cite[\S\ref{TFF_Finite.p}]{SS+26-Appendix} shows a TFF problem that has a 
countermodel with finite domains, which is shown in 
\example{}:\cite[\S\ref{TFF_Finite.s}]{SS+26-Appendix}.
...
\example{}:\cite[\S\ref{TFF_Finite.s.p}]{SS+26-Appendix} shows the verification problem for 
the model.
...
\example{}:\cite[\S\ref{TFF_Finite.p}]{SS+26-Appendix} shows a TFF problem that has a 
countermodel with finite domains, which is shown in 
\example{}:\cite[\S\ref{TFF_Finite_SeparateDomains.s}]{SS+26-Appendix}.
\example{}:\cite[\S\ref{THF_Finite.p}]{SS+26-Appendix} shows a THF problem that has a 
countermodel with finite domains, which is shown in
\example{}:\cite[\S\ref{THF_Finite.s}]{SS+26-Appendix}.
...
\example{}:\cite[\S\ref{TFF_Finite_SeparateDomains.s.p}, 
...
\smalltt{\$int}.
\example{}:\cite[\S\ref{TFF_Infinite.p}]{SS+26-Appendix} shows a TFF problem that has a 
model with an infinite domain.
\example{}:\cite[\S\ref{TFF_Peano.s}]{SS+26-Appendix} shows the model with an infinite term 
domain, and \example{}:\cite[\S\ref{TFF_Integer.s}]{SS+26-Appendix} shows the model with an
\smalltt{\$int} domain.
...
\example{}:\cite[\S\ref{TFF_Peano.s.p}, \S\ref{TFF_Integer.s.p}]{SS+26-Appendix} show the 
...
interpretation.
\example{}:\cite[\S\ref{FOF_Finite_Medium.s}, \S\ref{TFF_Finite_Medium.s}]{SS+26-Appendix}
show examples of splitting the interpretation-formulae in the FOF and TFF 
interpretations \example{}:\cite[\S\ref{FOF_Finite.s}, \S\ref{TFF_Finite.s}]{SS+26-Appendix} 
...
\example{}:\cite[\S\ref{FOF_Finite_Fine.s}, \S\ref{TFF_Finite_Fine.s}]{SS+26-Appendix} show 
examples of splitting the interpretation-formulae in
\example{}:\cite[\S\ref{FOF_Finite.s}, \S\ref{TFF_Finite.s}]{SS+26-Appendix} respectively.
...
\example{}:\cite[\S\ref{THF_Finite_Medium.s}]{SS+26-Appendix} shows an example of mixed 
splitting of \example{}:\cite[\S\ref{THF_Finite.s}]{SS+26-Appendix}.
...
\example{}:\cite[\S\ref{TFF_Finite_Compact.s}]{SS+26-Appendix} shows an example compacting 
...
\example{}:\cite[\S\ref{FOF_Finite.p}]{SS+26-Appendix} shows a problem that has a HI-formulae
model formed from predicate definitions over the term algebra, which is shown in 
\example{}:\cite[\S\ref{FOF_Formulae.s}]{SS+26-Appendix}.
\example{}:\cite[\S\ref{FOF_Finite.p}]{SS+26-Appendix} also has a saturation, which is shown 
in \example{}:\cite[\S\ref{FOF_Saturation.s}]{SS+26-Appendix}.
\example{}:\cite[\S\ref{FOF_Formulae.s.p}, \S\ref{FOF_Saturation.s.p}]{SS+26-Appendix} show 
...
in \example{}:\cite[\S\ref{TFF_Finite_SeparateDomains.s}]{SS+26-Appendix}.
...
\example{}:\cite[\S\ref{NXF_Finite-Finite-Global.s}, 
...
\example{}:\cite[\S\ref{NXF_Finite-Finite-Global_Medium.s},
...
\example{}:\cite[\S\ref{NXF_Finite-Finite-Global_Compact.s}]{SS+26-Appendix} illustrate
...
\example{}:\cite[\S\ref{NXF_Finite-Finite-Global.p}]{SS+26-Appendix} shows a NXF problem 
that has a countermodel with finite worlds, each of which contains a finite Tarskian 
interpretation, which is shown in 
\example{}:\cite[\S\ref{NXF_Finite-Finite-Global.s}]{SS+26-Appendix}.
...
\example{}:\cite[\S\ref{NXF_Finite-Finite-Local.p}]{SS+26-Appendix} shows a NXF problem 
...
which is shown in \example{}:\cite[\S\ref{NXF_Finite-Finite-Local.s}]{SS+26-Appendix}.
This example illustrates how a local axiom (with role \smalltt{axiom-local}) is satisfied in 
only the local world (\smalltt{w1}).
\example{}:\cite[\S\ref{NXF_Finite-Finite-Local.s.p}]{SS+26-Appendix} shows the verification 
...
\smalltt{domains}, and \smalltt{mappings}.
\example{}:\cite[\S\ref{NXF_Finite-Finite-Global_Medium.s}]{SS+26-Appendix} shows a medium 
grained split of \example{}:\cite[\S\ref{NXF_Finite-Finite-Global.s}]{SS+26-Appendix}.
...
In \example{}:\cite[\S\ref{NXF_Finite-Finite-Global_Medium.s}]{SS+26-Appendix} the
...
\example{}:\cite[\S\ref{NXF_Finite-Finite-Global_Fine.s}]{SS+26-Appendix} shows a more fine 
grained split of \example{}:\cite[\S\ref{NXF_Finite-Finite-Global.s}]{SS+26-Appendix}. 
...
\example{}:\cite[\S\ref{NXF_Finite-Finite-Global_Compact.s}]{SS+26-Appendix} shows a compacted 
version of \example{}:\cite[\S\ref{NXF_Finite-Finite-Global.s}]{SS+26-Appendix}. 
The interpretation-formula: \\
...
\example{}:\cite[\S\ref{NXF_Finite-Finite-Global.p}, 
...
\example{}:\cite[\S\ref{NXF_Finite-Finite-Global.s.p}]{SS+26-Appendix} shows the NXF 
verification problem for the NXF problem
\example{}:\cite[\S\ref{NXF_Finite-Finite-Global.p}]{SS+26-Appendix} and its countermodel 
in \example{}:\cite[\S\ref{NXF_Finite-Finite-Global.s}]{SS+26-Appendix}.
\example{}:\cite[\S\ref{NXF_Finite-Finite-Local.s.p}]{SS+26-Appendix} shows the NXF 
verification problem for the problem in 
\example{}:\cite[\S\ref{NXF_Finite-Finite-Local.p}]{SS+26-Appendix} and its countermodel in 
\example{}:\cite[\S\ref{NXF_Finite-Finite-Local.s}]{SS+26-Appendix}.
...
In \example{}:\cite[\S\ref{NXF_Finite-Finite-Global.p}]{SS+26-Appendix} the axiom: \\
...
\example{}:\cite[\S\ref{NXF_Finite-Finite-Global.s.p}]{SS+26-Appendix} has the 

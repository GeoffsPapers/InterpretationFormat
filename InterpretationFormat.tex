...
\begin{itemize}
\item Interpretations that have a domain and symbol mappings -- {\sf D+M} interpretations --
      that come in two forms~\ldots
      \begin{packed_itemize}
      \item {\em Finite} {\sf D+M} interpretations have only finite domains.
            ...
            \cite{CS03,McC03-MACE4-TR} or function free clause logic \cite{BF+09}, both of which 
            are decidable logics.
            ...
            Vampire.
      \item {\em Infinite} {\sf D+M} interpretations have one or more infinite domains.
            ...
            % HOW IS THIS DONE?
            There are some ATP systems that produce infinite models, e.g., cvc5 \cite{BB+22-cvc5}, 
            Z3.
      \end{packed_itemize}

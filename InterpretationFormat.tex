...
formed with the interpretation-formulae as axioms, and the problem formulae as a conjecture (when 
verifying a countermodel, the conjecture of the problem is negated).
...
splitting the models in Appendices~\ref{FOF_Finite.s} and~\ref{TFF_Finite.s} respectively.
...
models in Appendices~\ref{FOF_Finite.s} and~\ref{TFF_Finite.s} respectively..

...
\item {\em Formulae} that are intended to represent Herbrand interpretations, written 
      ...
      Examples include a disjunction of implicit generalisations (DIGs) \cite{LM87}, 
      sets of constrained unit clauses \cite{CZ92,CP95,CP95-TAB}, SGGS clause sequences 
      \cite{BP16}, various representations of tableaux (as long as you use a proof confluent 
      calculus, it is normally possible to construct a model from a saturated branch) 
      \cite{Hah01}, eq-interpretations \cite{Pel03-EQMC}, and 
...
\begin{small}
\verbatiminput{NTF_Finite-Finite-Global.s.NTF.p}
\end{small}
...
\begin{small}
\verbatiminput{NTF_Finite-Finite-Local.s.NTF.p}
\end{small}

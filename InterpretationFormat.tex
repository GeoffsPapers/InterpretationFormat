...
\item For interpretations represented by an interpretation formula in the new TPTP format,
      ...
      This is proved for FOF interpretations in \cite{SS+23-LPAR}, and the proof extends
      DID I WRITE THIS ALREADY? ZZZZZZZZZ.
\item For Herbrand interpretations induces by formulae, theorem proving can be used~\ldots
      \begin{packed_itemize}

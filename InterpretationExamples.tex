...
to the paper that describes the format.
\end{abstract}
\begin{keywords}
  TPTP World \sep
  Interpretations
...
This document provides examples of interpretations written in the TPTP format for interpretations, 
as a companion document to the paper that describes the format~\cite{SS+26}.
